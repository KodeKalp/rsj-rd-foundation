...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Navbar for Desktop */}
      <div className="hidden lg:block navbar bg-[#000000c4] text-white fixed w-full sm:top-12 z-40 lg:z-50 shadow-md">
          ...
          >
            <div className="flex flex-col space-y-4 p-4">
              ...
              >
                ...
                >
                  <div className="bg-black text-white mt-2 py-2 w-full">
                    <Link
                      to="/detail-page"
                      className="block px-4 py-2 hover:bg-[#E35A1E]"
                      onClick={() => {
